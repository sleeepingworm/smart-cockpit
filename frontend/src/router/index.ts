  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'fatigue',  name: 'CockpitFatigue',  component: () => import('@/views/cockpit/tabs/PlaceholderTab.vue'), meta: { title: '疲劳检测' } },
        { path: 'obstacle', name: 'CockpitObstacle', component: () => import('@/views/cockpit/tabs/PlaceholderTab.vue'), meta: { title: '障碍物检测' } },
